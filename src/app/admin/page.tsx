...
type CodeRow = {
  ...
  maxProjects: number | null; expiresAt: string | null; createdAt: string;
  lastUsedAt: string | null; projectCount: number;
};
    ...
    <main className="admin-shell">
      ...
      <section className="admin-panel">
        ...
        <div className="admin-table-wrap">
          <table>
            <thead>
              <tr><th>兑换码</th><th>备注</th><th>项目</th><th>有效期</th><th>最后使用</th><th>状态</th><th></th></tr>
            </thead>
            <tbody>
              {codes.map(row => (
